...
const AboutUs = () => {
  ...
  return (
    <div className="bg-[var(--bg-primary)] text-[var(--text-primary)] transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div>
              ...
              <p className="text-[var(--text-secondary)] text-sm leading-relaxed">{t.qText}</p>
            </div>
            <div>
              <div className="w-16 h-16 bg-beige rounded-full flex items-center justify-center mx-auto mb-6 text-brand">
              ...
              <p className="text-[var(--text-secondary)] text-sm leading-relaxed">{t.dText}</p>
            </div>
            <div>
              <div className="w-16 h-16 bg-beige rounded-full flex items-center justify-center mx-auto mb-6 text-brand">
              ...
              <p className="text-[var(--text-secondary)] text-sm leading-relaxed">{t.sText}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Craftsmanship */}
      <section className="py-20 bg-[var(--bg-secondary)] transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
