...
const Contact = () => {
  ...
  const socialLinks = {
    ...
    instagram: contactInfo.instagram || fallbackSocialLinks.instagram,
    tiktok: contactInfo.tiktok || fallbackSocialLinks.tiktok
  };
  const address = contactInfo.address?.[language] || t.address;
  const email = contactInfo.email || 'support@meloraluxury.com';
            ...
            <div className="w-full md:w-1/3">
              ...
              <div className="space-y-6 text-[var(--text-secondary)]">
                ...
                <div>
                  ...
                  <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 mt-2 rounded-full text-sm font-medium transition-colors">
                ...
                <div>
                  ...
                  <div className="flex space-x-4 mt-2">
                    <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#25D366] transition-colors duration-300" aria-label="WhatsApp">
                    ...
                    <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#E1306C] transition-colors duration-300" aria-label="Instagram">
                    ...
                    <a href={socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[var(--text-primary)] transition-colors duration-300" aria-label="TikTok">
