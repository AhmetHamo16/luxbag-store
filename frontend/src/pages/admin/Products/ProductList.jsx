...
const ProductList = () => {
  ...
  const uiMap = {
    ...
    tr: {
      deleteProduct: 'Ürünü Sil', deleteConfirm: 'Bu ürün kalıcı olarak silinsin mi?', duplicateProduct: 'Ürünü Kopyala', duplicateConfirm: 'Bu ürün tüm varyant ve görsellerle kopyalansın mı?', productDeleted: 'Ürün başarıyla silindi', productDuplicated: 'Ürün başarıyla kopyalandı', bulkDone: 'Toplu işlem tamamlandı', actionFailed: 'İşlem başarısız oldu', statusUpdated: 'Durum güncellendi', statusUpdateFailed: 'Durum güncellenemedi', selectAction: 'Bir işlem seçin', selectOne: 'En az bir ürün seçin', selectTargetCategory: 'Lütfen hedef kategori seçin.', confirmBulk: 'Toplu İşlemi Onayla', executeBulk: 'Uygula', productsWord: 'ürün', selected: 'Seçili', bulkActions: 'Toplu İşlemler', deleteSelected: 'Seçilenleri Sil', changeCategory: 'Kategori Değiştir', markFeatured: 'Öne Çıkan Durumu', enableDisable: 'Etkin / Gizli', selectCategory: 'Kategori Seç', selectStatus: 'Durum Seç', featureOn: 'Öne Çıkar', featureOff: 'Öne Çıkarmayı Kaldır', enableActive: 'Etkinleştir', disableHidden: 'Gizle', allCategories: 'Tüm Kategoriler', allStatuses: 'Tüm Durumlar', activeOnly: 'Sadece Aktif', inactiveOnly: 'Sadece Pasif', featuredOnly: 'Sadece Öne Çıkan', allStock: 'Tüm Stok', inStock: 'Stokta Var', outOfStock: 'Stokta Yok', lowStock: 'Düşük Stok (< 5)', searchByName: 'İsme göre ara...', productDetails: 'Detayları', stock: 'Stok', date: 'Tarih', unknown: 'Bilinmiyor', uncategorized: 'Kategorisiz', variants: 'Varyant', pcsTotal: 'adet toplam', pcs: 'adet', active: 'Aktif', hidden: 'Gizli', featured: 'Öne Çıkan', standard: 'Standart', duplicate: 'Kopyala', noProducts: 'Ürün bulunamadı. Yeni ürün ekleyin!', showing: 'Gösterilen', to: '-', of: 'toplam', results: 'sonuç', previous: 'Önceki', next: 'Sonraki', confirm: 'Onayla', readyLabel: 'Hazır', lowStockLabel: 'Az sayıda kaldı', outOfStockLabel: 'Stokta yok', printBarcode: 'Barkodu Yazdır', barcodeLabel: 'Barkod Etiketi', barcodeMissing: 'Bu ürün için henüz barkod tanımlanmamış.', barcodeValue: 'Barkod'
    }
  };
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {paginatedProducts.length > 0 ? paginatedProducts.map((product, index) => {
                        ...
                        const imageSrc = resolvedImage.includes('via.placeholder.com')
                          ? resolvedImage
                          : `${resolvedImage}${resolvedImage.includes('?') ? '&' : '?'}v=${cacheKey}`;
