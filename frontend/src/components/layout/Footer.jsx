      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-beige/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-beige/50 text-center md:text-left">
          ...
          <div className="flex space-x-6">
            <a href={socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="text-beige/70 hover:text-[#25D366] transition-colors duration-300" aria-label="WhatsApp">
            ...
            <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-beige/70 hover:text-[#E1306C] transition-colors duration-300" aria-label="Instagram">
            ...
            <a href={socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="text-beige/70 hover:text-white transition-colors duration-300" aria-label="TikTok">
