...
const orderSchema = new mongoose.Schema({
  ...
  preferredLanguage: { type: String, enum: ['en', 'ar', 'tr'], default: 'en' },
  status: { type: String, enum: ['pending_payment', 'pending', 'confirmed', 'processing', 'out_for_delivery', 'shipped', 'delivered', 'cancelled'], default: 'pending_payment' },
