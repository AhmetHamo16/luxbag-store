  ...
  const localizedContent = {
    ...
    tr: {
      pending_payment: {
        ...
        title: 'Siparisiniz ozenle kayda alindi',
        greeting: 'Merhaba',
        message: 'Melora\'ya gosterdiginiz guven icin tesekkur ederiz. Siparisiniz basariyla tarafimiza ulasti. Odeme dekontunuz titizlikle incelendikten sonra tum surec boyunca sizi e-posta ile bilgilendirecegiz.',
        cta: 'Siparisinizi inceleyin',
      },
      pending: {
        subject: 'Melora siparisiniz basariyla alindi',
        title: 'Siparisiniz artik Melora\'da',
        greeting: 'Merhaba',
        message: 'Siparisiniz basariyla olusturuldu. Melora ekibi siparisinizi ozenle inceleyerek hazirlama surecine en kisa zamanda baslayacaktir.',
        cta: 'Siparis durumunu goruntuleyin',
      },
      confirmed: {
        subject: 'Melora siparisiniz onaylandi',
        title: 'Siparisiniz onaylandi',
        greeting: 'Merhaba',
        message: 'Siparisiniz ekibimiz tarafindan onaylandi. Simdi siparisinizi, Melora deneyimine yakisir bir ozenle hazirlama asamasina geciyoruz.',
        cta: 'Siparisinizi takip edin',
      },
      processing: {
        subject: 'Melora siparisiniz ozenle hazirlaniyor',
        title: 'Siparisiniz hazirlaniyor',
        greeting: 'Merhaba',
        message: 'Ekibimiz siparisinizi su anda paketleme ve son hazirlik asamasina aldi. Kisa sure sonra kargoya teslim edilmek uzere hazir olacak.',
        cta: 'Siparis durumunu goruntuleyin',
      },
      shipped: {
        subject: 'Melora siparisiniz kargoya verildi',
        title: 'Siparisiniz yola cikti',
        greeting: 'Merhaba',
    ...
    en: {
      pending_payment: {
        subject: 'Your Melora order has been received and is awaiting payment review',
        title: 'Your order has been beautifully received',
        greeting: 'Hello',
        message: 'Thank you for choosing Melora. Your order has been received successfully, and our team will carefully review your payment confirmation before sharing the next update with you by email.',
        cta: 'Review your order',
      },
      pending: {
        subject: 'We received your Melora order',
        title: 'Your order is now with Melora',
        greeting: 'Hello',
        message: 'Your order has been placed successfully. The Melora team will now review every detail and begin preparing it with the care and attention your experience deserves.',
      ...
      confirmed: {
        ...
        greeting: 'Hello',
        message: 'We are delighted to let you know that your order has been confirmed. Our team is now moving forward with the preparation process with special care.',
        cta: 'Track your order',
      },
      processing: {
        subject: 'Your Melora order is being carefully prepared',
        title: 'Your order is being prepared',
        greeting: 'Hello',
        message: 'The Melora team is currently preparing and packaging your order with care, getting it ready for shipment.',
        cta: 'View your order status',
      },
      shipped: {
        subject: 'Your Melora order is now on its way',
